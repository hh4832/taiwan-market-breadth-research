...
def build_metadata(config: V6Config, dataset: pd.DataFrame, breadth_metadata: dict, selected_keys: dict) -> pd.DataFrame:
    ...
    items = {
        ...
        "price_source_open": selected_keys.get("adj_open"),
        "price_source_close": selected_keys.get("adj_close"),
        "outcome_price_adjusted": selected_keys.get("adj_open") == "etl:adj_open" and selected_keys.get("adj_close") == "etl:adj_close",
